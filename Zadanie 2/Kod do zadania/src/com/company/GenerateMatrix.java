...
public class GenerateMatrix {
    ...
    public static void main(String[] args) {
        ...
        generate(20, 20, "A20", -65536, 65535);
        generate(20, 20, "B20", -65536, 65535);
        generate(20, 20, "C20", -65536, 65535);
        generate(1, 20, "X20", -65536, 65535);
        generate(21, 20, "Gauss20", -65536, 65535);
        ...
        generate(40, 40, "A40", -65536, 65535);
        generate(40, 40, "B40", -65536, 65535);
        generate(40, 40, "C40", -65536, 65535);
        generate(1, 40, "X40", -65536, 65535);
        generate(41, 40, "Gauss40", -65536, 65535);
        ...
        generate(1000, 1000, "A1000", -65536, 65535);
        generate(1000, 1000, "B1000", -65536, 65535);
        generate(1000, 1000, "C1000", -65536, 65535);
        generate(1, 1000, "X1000", -65536, 65535);
        generate(1001, 1000, "Gauss1000", -65536, 65535);

        generate(2000, 2000, "A2000", -65536, 65535);
        generate(2000, 2000, "B2000", -65536, 65535);
        generate(2000, 2000, "C2000", -65536, 65535);
        generate(1, 2000, "X2000", -65536, 65535);
        generate(2001, 2000, "Gauss2000", -65536, 65535);
    }
}
