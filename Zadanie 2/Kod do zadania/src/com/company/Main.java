...
public class Main {
    ...
    public static void measureOperations(Integer[] forFraction, Integer[] forOtherTypes, MatrixOperations<MyFloat> matrixOperationsFloat, MatrixOperations<MyDouble> matrixOperationsDouble, MatrixOperations<MyFraction> matrixOperationsFraction, MatrixLibrary matrixLibrary, String fileName) throws IOException {
        for (Integer iter : forOtherTypes) {
            ReadMatrixData matrix = new ReadMatrixData(fileName, iter).collectData();
    ...
    public static void measureGauss(Integer[] forFraction, Integer[] forOtherTypes, MatrixOperations<MyFloat> matrixOperationsFloat, MatrixOperations<MyDouble> matrixOperationsDouble, MatrixOperations<MyFraction> matrixOperationsFraction, MatrixLibrary matrixLibrary, ResultToSave resToSave, String fileName) throws IOException {
        for (Integer iter : forOtherTypes) {
            ReadMatrixData matrix = new ReadMatrixData(fileName, iter).collectData();
    ...
    public static void main(String[] args) throws IOException {
        ...
        measureOperations(forFraction, forOtherTypes, matrixOperationsFloat, matrixOperationsDouble, matrixOperationsFraction, matrixLibrary, "500");
        measureGauss(forFraction, forOtherTypes, matrixOperationsFloat, matrixOperationsDouble, matrixOperationsFraction, matrixLibrary, resToSave, "500");
    }
}
