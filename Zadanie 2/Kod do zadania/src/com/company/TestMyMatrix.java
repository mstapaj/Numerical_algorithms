...
//        Float l1 = new MyFloat(2F);
//        Float l2 = new MyFloat(5F);
//        Float l3 = new MyFloat(1F);
//        Float l4 = new MyFloat(-2F);
//        Collections.addAll(listToMat, l1, l2, l3, l4);
//        MyMatrix<Float> sut = new MyMatrix<>(2, 2, listToMat);
//        List<Float> listToMat2 = new ArrayList<>();
//        Float l5 = new MyFloat(3F);
//        Float l6 = new MyFloat(-1F);
//        Float l7 = new MyFloat(7F);
//        Float l8 = new MyFloat(4F);
//        Collections.addAll(listToMat2, l5, l6, l7, l8);
...
//        Collections.addAll(listToMat, l1, l2, l3, l4);
//        MyMatrix sut = new MyMatrix<>(2, 2, listToMat);
...
//        List<BigDecimal> row1 = new ArrayList<>();
//        List<BigDecimal> row2 = new ArrayList<>();
//        Collections.addAll(row1, new MyFraction(BigInteger.valueOf(11), BigInteger.valueOf(16)).getFraction(), new MyFraction(BigInteger.valueOf(31), BigInteger.valueOf(48)).getFraction());
//        Collections.addAll(row2, new MyFraction(BigInteger.valueOf(11), BigInteger.valueOf(18)).getFraction(), new MyFraction(BigInteger.valueOf(25), BigInteger.valueOf(72)).getFraction());
//        Collections.addAll(res, row1, row2);
//        sut.multiplyMatrix(sut2);
//        List<List<BigDecimal>> result = new ArrayList<>();
//        for (int i = 0; i < sut.getMatrix().size(); i++) {
...
//        List<BigDecimal> row1 = new ArrayList<>();
//        List<BigDecimal> row2 = new ArrayList<>();
//        Collections.addAll(row1, new MyFraction(BigInteger.ONE, BigInteger.ONE).getFraction(), new MyFraction(BigInteger.valueOf(13), BigInteger.valueOf(12)).getFraction());
//        Collections.addAll(row2, new MyFraction(BigInteger.valueOf(4), BigInteger.valueOf(3)).getFraction(), new MyFraction(BigInteger.valueOf(11), BigInteger.valueOf(12)).getFraction());
//        Collections.addAll(res, row1, row2);
//        sut.addingMatrix(sut2);
//        List<List<BigDecimal>> result = new ArrayList<>();
//        for (int i = 0; i < sut.getMatrix().size(); i++) {
