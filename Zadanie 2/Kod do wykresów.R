...
floatResGfirst<-c(0,3,3)
doubleResGfirst<-c(0,3,15)
fractionResGfirst<-c(13,6768,174926)
libraryResGfirst<-c(5,0,1)
floatResGsecond<-c(13,367,1890)
doubleResGsecond<-c(20,368,2050)
libraryResGsecond<-c(1,22,34)

floatResPGfirst<-c(0,3,12)
doubleResPGfirst<-c(0,3,14)
fractionResPGfirst<-c(12,7561,192599)
libraryResPGfirst<-c(5,0,1)
floatResPGsecond<-c(45,1505,6032)
doubleResPGsecond<-c(41,1604,6319)
libraryResPGsecond<-c(1,22,34)

floatResFGfirst<-c(0,3,4)
doubleResFGfirst<-c(0,4,4)
fractionResFGfirst<-c(12,7517,195025)
libraryResFGfirst<-c(5,0,1)
floatResFGsecond<-c(49,1824,7289)
doubleResFGsecond<-c(51,1915,7637)
libraryResFGsecond<-c(1,22,34)
