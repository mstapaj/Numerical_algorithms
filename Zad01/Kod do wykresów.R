...
plot(data$Taylor_od_lewej,type="l",xlab="k¹t",ylab="wartoœæ")
plot(data$Taylor_od_prawej,type="l",xlab="k¹t",ylab="wartoœæ")
plot(data$Taylor_od_lewej_prev,type="l",xlab="k¹t",ylab="wartoœæ")
plot(data$Taylor_od_prawej_prev,type="l",xlab="k¹t",ylab="wartoœæ")
plot(data$Taylor_z_func_wbudowanych,type="l",xlab="k¹t",ylab="wartoœæ")

plot(data$Kat,data$Taylor_od_lewej,type="l",xlab="k¹t",ylab="wartoœæ")
lines(data$Kat,data$Taylor_od_prawej,col="RED")

plot(data$Kat,data$Taylor_z_func_wbudowanych-data$Taylor_od_lewej,type = "l")
